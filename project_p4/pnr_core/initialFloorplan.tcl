# Floorplan
floorPlan -site core -s 1200 1200 10 10 10 10
...
placeInstance psum_mem_instance 500.0 500.0 R0
placeInstance qmem_instance 50.0 50.0 R0
placeInstance kmem_instance 500.0 50.0 R0
...
addStripe -skip_via_on_wire_shape Noshape -block_ring_top_layer_limit M1 -max_same_layer_jog_length 0.8 -padcore_ring_bottom_layer_limit M1 -number_of_sets 150 -skip_via_on_pin Standardcell -stacked_via_top_layer M8 -padcore_ring_top_layer_limit M1 -spacing 3 -merge_stripes_value 0.1 -direction horizontal -layer M5 -block_ring_bottom_layer_limit M1 -width 2 -area {} -nets {VDD VSS} -stacked_via_bottom_layer M1
