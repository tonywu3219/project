streamOut ${design}.gds2 -merge {./subckt/sram_w16_64b.gds2 ./subckt/sram_w16_160b.gds2}
write_lef_abstract -stripePin -PGPinLayers {5} -extractBlockPGPinLayers {5} ${design}.lef -specifyTopLayer 5
