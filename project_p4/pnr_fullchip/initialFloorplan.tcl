# Floorplan
floorPlan -site core -s 1400 2800 10 10 10 10
...
placeInstance core_instance0 100.0 100 R0
placeInstance core_instance1 100.0 1500 R0
...
globalNetConnect VSS -type pgpin -pin VSS -sinst core_instance0 -verbose -override
globalNetConnect VDD -type pgpin -pin VDD -sinst core_instance1 -verbose -override
